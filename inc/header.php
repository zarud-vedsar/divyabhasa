            ...
            <div class="header-top bg-blue-111 sm-text-center p-0">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-1 ">
                            <a  class="btn btn-colored  btn-theme-colored  pb-10" id="logingbtn"  href="#promoModal2" data-lightbox="inline">Login</a>
                            
                        </div>
                        <div class="col-md-1 ">
                            <a  class="btn btn-colored  btn-theme-colored  pb-10" href="#promoModal1" data-lightbox="inline" >Register</a>
