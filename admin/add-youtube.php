...
<div class="page-wrapper">
    ...
    <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <h3 class="page-title">Youtube Live <?= @$tutorial_id ? 'Edit' : 'Add' ?></h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="./index.php">Home</a></li>
                            <li class="breadcrumb-item"><a href="./youtube.php">Youtube Live</a></li>
                            <li class="breadcrumb-item active">Youtube Live <?= @$tutorial_id ? 'Edit' : 'Add' ?></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <form id="submit_youtube">
                        <div class="row">
                            <div class="col-12">
                                <h5 class="form-title student-info">Youtube Information</h5>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group local-forms">
                                    <label>Youtube Title <span class="login-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group local-forms">
                                    ...
                                    <input name="start_date" id="start_date" type="date" class="form-control" placeholder="Enter Video Url" value="<?= @$select_tutorial[0]['start_date'] ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group local-forms">
                                    <label>Start Time <span class="login-danger">*</span></label>
                                    <input name="start_time" id="start_time" type="time" class="form-control" value="<?= @$select_tutorial[0]['start_time'] ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group local-forms">
                                    <label>End Time <span class="login-danger">*</span></label>
                                    <input name="end_time" id="end_time" type="time" class="form-control" value="<?= @$select_tutorial[0]['end_time'] ?>">
                                </div>
                            </div>
<input type="hidden" name="video_input" id="video-input" value="<?= @$select_tutorial[0]['thumb'] ?>">
    ...
    <script>
        ...
        function removeimgth(id) {
            ...
            $.ajax({
                url: `removeimgyoutube.php?id=${id}`,
                success: function(response) {
