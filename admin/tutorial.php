            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-end mb-4">
                        <a href="./add-tutorial.php" class="btn btn-primary">Add Tutorial</a>
                    </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr id="removeTutorialDelete_<?= @$tutorial['id'] ?>">
                                            ...
                                            <td class="text-end">
                                                <div class="actions">
                                                    <a href="./add-tutorial.php?tutorial_id=<?= @$tutorial['id'] ?>" class="btn btn-sm bg-danger-light" title="Edit">
